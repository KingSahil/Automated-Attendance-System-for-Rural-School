        ...
        try {
            ...
            if (typeof firebase !== 'undefined') {
                ...
                if (!firebase.apps.length) {
                    firebase.initializeApp(this.firebaseConfig.apiKey !== 'your-api-key' ? this.firebaseConfig : defaultConfig);
                }
            ...
            for (const entry of this.attendanceData) {
                if (!entry.synced) {
                    ...
                    await docRef.set({
                        ...entry,
                        deviceId: deviceId,
                        teacherName: settings.teacherName || 'Unknown',
                        classSubject: settings.classSubject || 'Unknown',
                        schoolName: settings.schoolName || 'Unknown',
